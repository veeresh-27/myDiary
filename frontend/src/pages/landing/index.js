  ...
  return (
    <div className="justify-center bg-background page-row">
      <div className="flex flex-col justify-center w-full h-full gap-4 pt-20">
        <h1 className="flex self-center text-2xl font-semibold text-center sm:text-4xl md:text-5xl lg:text-6xl">
          Welcome to My Diary
        </h1>
        <div className="text-sm text-center md:text-md lg:text-xl">
          Place for all of your thoughts
        </div>
